...
<div id="standardGrid" style="display:flex; width:100%; gap:8px;">
    ...
    <!-- दायाँ 48%: स्विचेस + इन-प्लेस लाइव कैमरा + इनलाइन सेटिंग्स -->
...
<script>
    ...
    if (rec) {
        ...
        rec.onresult = (e) => {
            ...
            try {
                ...
                micStatus.innerText = "टाइप बार से भेजें";
            }
        };
    ...
    function triggerMicVoice() {
        ...
        if (rec) {
            ...
            micStatus.innerText = "ब्राउज़र नॉट सपोर्टेड";
        }
    }
